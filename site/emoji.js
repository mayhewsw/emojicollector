...
function emoji(){}
	 ...
	 */
	emoji.img_sets = {
		'apple'    : {'path' : base + 'emoji-data/img-apple-64/'   , 'sheet' : 'emoji-data/sheet_apple_64.png',    'mask' : 1 },
		'google'   : {'path' : base + 'emoji-data/img-google-64/'  , 'sheet' : 'emoji-data/sheet_google_64.png',   'mask' : 2 },
		'twitter'  : {'path' : base + 'emoji-data/img-twitter-64/' , 'sheet' : 'emoji-data/sheet_twitter_64.png',  'mask' : 4 },
		'emojione' : {'path' : base + 'emoji-data/img-emojione-64/', 'sheet' : 'emoji-data/sheet_emojione_64.png', 'mask' : 8 }
	};
